...
local on_attach = function(client, bufnr)
	...
	buf_set_keymap("n", "gD", ":lua vim.lsp.buf.declaration()<CR>", opts) --> jumps to the declaration of the symbol under the cursor
	...
	buf_set_keymap("n", "gy", ":lua vim.lsp.buf.type_definition()<CR>", opts) --> jumps to the type definition of the symbol under the cursor
